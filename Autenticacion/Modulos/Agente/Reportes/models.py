...
class DetIncidente_Model(models.Model):
    ...
    evidencia = models.FileField(upload_to='evidencias',validators=[FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'gif', 'mp4', 'mov', 'avi'])],blank=True,null=True,help_text="Evidencia adjunta (opcional)")
